define('frozen', function(require, exports, module) {
  ...
  (function (root, factory) {
      ...
      !(function ($) {
          ...
          // 构造函数
          var Dialog = function Dialog(el, option, isFromTpl) {
      ...
      !(function ($) {
          ...
          // 默认模板
          var _loadingTpl = '<div class="ui-loading-block show">' + '<div class="ui-loading-cnt">' + '<i class="ui-loading-bright"></i>' + '<p><%=content%></p>' + '</div>' + '</div>';
          ...
          // 构造函数
          var Loading = function Loading(el, option, isFromTpl) {
              var self = this;
              this.element = $(el);
              this._isFromTpl = isFromTpl;
              this.option = $.extend(defaults, option);
          ...
          Scroll.prototype = {
              ...
              _move: function _move(e) {
                  ...
                  if (this.options.preventDefault) {
                      // 这么做才能确保 Android 下 touchend 能被正常触发（需测试）
                      e.preventDefault();
                  }
                  var point = e.touches ? e.touches[0] : e,
              ...
              _end: function _end(e) {
                  ...
                  var point = e.changedTouches ? e.changedTouches[0] : e,
                      // 移开屏幕的那个触摸点，只会包含在 changedTouches 列表中，而不会包含在 touches 或 targetTouches 列表中
                  momentumX,
                      momentumY,
      ...
      !(function ($) {
          ...
          // 默认模板
          var _tipsTpl = '<div class="ui-poptips ui-poptips-<%=type%>">' + '<div class="ui-poptips-cnt">' + '<i></i><%=content%>' + '</div>' + '</div>';
