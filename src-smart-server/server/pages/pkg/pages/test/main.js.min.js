define('pages/test/main', function(require, exports, module) {
  ...
  /**
   * main
   * @require 'pages/test/index.scss' // 无需在页面中控制 css
   */
...
;define('z-template', function(require, exports, module) {
...
;define('z-template-1', function(require, exports, module) {
  ...
  var menuTpl = require('z-template-1.tpl');
...
;define('z-template-1.tpl', function(require, exports, module) {
  ...
  return  function (it, opt) {
   ...
   for ( var i = 0 ,len = data.length; i < len; i++){ loop.index = i; item = data[i]; if(loop.index === 0){ loop.first === true;}else{ loop.first = false; }
