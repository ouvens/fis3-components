define('pages/detail/main', function(require, exports, module) {
  ...
  var liTpl = require('choice-list.tpl');
  
  var dataList = require('data-list');
  var choiceList = {
      $el: $('#select-nav'),
      init: function init(data1, data2) {
          this._renderData(data1, data2);
          this._bindEvent();
      },
      _renderData: function _renderData(data1, data2) {
...
;define('choice-list.tpl', function(require, exports, module) {
  ...
  return function (it, opt) {
      ...
      with(it) {
        ...
        _$out_.push(' <li class="title" id="list',  i , '">',  data[i] , '<i class="ui-icon-unfold title-icon"></i></li>');
         } 
  ...
  var list1 = require('data-list.tpl'),
      list2 = require('data-list.tpl'),
      list3 = require('data-list.tpl');
  var labelList = {
      $el: $('#container'),
...
;define('data-list.tpl', function(require, exports, module) {
