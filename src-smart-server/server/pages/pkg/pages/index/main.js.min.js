define('pages/index/main', function(require, exports, module) {
  ...
  var tab = {
      ...
      _renderData: function _renderData(data) {
...
;define('index.tpl', function(require, exports, module) {
  ...
  return function (it, opt) {
      ...
      with(it) {
        ...
        _$out_.push(' <li> <a href="',  data[i].url , '"> <img src="',  data[i].image , '" alt="data[i].title"> </a> </li>');
         } 
  ...
  return function (it, opt) {
      ...
      with(it) {
          var _$out_= [];
          _$out_.push('<li> <ul class="page"> ');
         for(var i = 0, len = data.length; i < len; i++ ){ 
        _$out_.push(' ');
         if( i>0 && i%8 === 0) {
        _$out_.push(' </ul> </li> <li> <ul class="page"> ');
         } 
        _$out_.push(' <li class="page-item" data-href="',  data[i].url , '"> <span class="page-item-bd ',  data[i].icon , '" style="background-image:url(http://placeholder.qiniudn.com/100x100)"></span> <span class="page-item-ft">',  data[i].title , '</span> </li> ');
         } 
        _$out_.push(' </ul></li>');
        return _$out_.join('');
      }
  ...
  return function (it, opt) {
      ...
      with(it) {
         ...
         for(var i = 0, len = data.length; i < len; i++ ){ 
        _$out_.push(' <li class="ui-border-t"> <div class="ui-list-img"> <img src="',  data[i].image , '" alt="data[i].title" width="60" height="60"> </div> <div class="ui-list-info"> <p class="ui-nowrap">',  data[i].title , '</p> <p class="ui-nowrap">',  data[i].desc , '</p> </div> </li>');
         } 
  ...
  return function (it, opt) {
      ...
      with(it) {
          var _$out_= [];
          _$out_.push('<ul class="ui-grid-trisect"> ');
         for(var i = 0, len = data.list.length; i < len; i++ ){ 
        _$out_.push(' <li> <div class="ui-border"> <div class="ui-grid-trisect-img"> <a href="',  data.list[i].url , '"> <img src="',  data.list[i].image , '" alt=""> </a> </div> <div> <h4 class="ui-nowrap-multi">',  data.list[i].title , '</h4> </div> </div> </li> ');
         } 
        _$out_.push('</ul>');
        return _$out_.join('');
      }
  ...
  return function (it, opt) {
      ...
      with(it) {
          var _$out_= [];
          _$out_.push('<h2 class="ui-arrowlink" data-href="',  data.url , '"> ',  data.title , '<span class="ui-panel-subtitle">',  data.total || 0 , '条</span></h2><ul class="ui-grid-trisect"> ');
         for(var i = 0, len = data.list.length; i < len; i++ ){ 
        _$out_.push(' <li> <div class="ui-border"> <div class="ui-grid-trisect-img"> <a href="',  data.list[i].url , '"> <img src="',  data.list[i].image , '" alt=""> </a> </div> <div> <h4 class="ui-nowrap-multi">',  data.list[i].title , '</h4> <h5 class="ui-nowrap">',  data.list[i].desc , '</h5> </div> </div> </li> ');
         } 
        _$out_.push('</ul>');
        return _$out_.join('');
      }
  ...
  return function (it, opt) {
      ...
      with(it) {
         ...
         for(var i = 0, len = data.list.length; i < len; i++ ){ 
        _$out_.push(' <li class="ui-border-t" data-href="',  data.list[i].url , '"> <div class="ui-list-img"> <a href="',  data.list[i].url , '"> <img src="',  data.list[i].image , '" alt="',  data.list[i].title , '" width="90" height="70"> </a> </div> <div class="ui-list-info"> <h4 class="ui-nowrap">',  data.list[i].title , '</h4> <p class="ui-nowrap">',  data.list[i].desc , '</p> </div> </li>');
         } 
  ...
  return function (it, opt) {
      ...
      with(it) {
         ...
         for(var i = 0, len = data.list.length; i < len; i++ ){ 
        _$out_.push(' <li class="ui-border-t" data-href="data.list[i].url"> <div class="ui-list-img"> <img src="',  data.list[i].image , '" alt="data[i].title" width="90" height="70"> </div> <div class="ui-list-info"> <h4>',  data.list[i].title , '</h4> </div> </li>');
         } 
  ...
  return function (it, opt) {
      ...
      with(it) {
         ...
         for(var i = 0, len = data.length; i < len; i++ ){ 
        _$out_.push(' <label class="ui-label">',  data[i] , '</label>');
         } 
