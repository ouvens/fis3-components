  ...
  (function (root, factory) {
      ...
      var Random = (function () {
          ...
          Random.extend({
              ...
              format: function format(date, _format) {
                  ...
                  return _format.replace(rformat, function ($0, flag) {
              ...
              randomDate: function randomDate(min, max) {
          ...
          Random.extend({
              ...
              chineseName: function chineseName(count) {
          ...
          Random.extend({
              ...
              street_suffixes: function street_suffixes() {},
          ...
          Random.extend({
              ...
              increment: function increment(step) {
      ...
      Handle.extend({
          ...
          placeholder: function placeholder(_placeholder, obj, templateContext) {
              rplaceholder.exec("");
              var parts = rplaceholder.exec(_placeholder),
                  key = parts && parts[1],
          ...
          Mock4XTpl.tpl = function (node, context, options, helpers, partials, other) {
              if (node.params && node.params.length) {
                  other = Util.extend({}, other, {
                      ...
                      hold: ({
                          each: true,
                          "if": function _if(_, __, ___, name, value) {
                              return typeof value === "object";
                          },
                          unless: function unless(_, __, ___, name, value) {
                              return typeof value === "object";
                          },
                          "with": true,
                          include: false
