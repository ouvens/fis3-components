...
(function () {
    ...
    (function () {
        CKEDITOR.lang = {languages: {af: 1, ar: 1, bg: 1, bn: 1, bs: 1, ca: 1, cs: 1, cy: 1, da: 1, de: 1, el: 1, "en-au": 1, "en-ca": 1, "en-gb": 1, en: 1, eo: 1, es: 1, et: 1, eu: 1, fa: 1, fi: 1, fo: 1, "fr-ca": 1, fr: 1, gl: 1, gu: 1, he: 1, hi: 1, hr: 1, hu: 1, id: 1, is: 1, it: 1, ja: 1, ka: 1, km: 1, ko: 1, ku: 1, lt: 1, lv: 1, mk: 1, mn: 1, ms: 1, nb: 1, nl: 1, no: 1, pl: 1, "pt-br": 1, pt: 1, ro: 1, ru: 1, si: 1, sk: 1, sl: 1, sq: 1, "sr-latn": 1, sr: 1, sv: 1, th: 1, tr: 1, ug: 1, uk: 1, vi: 1, "zh-cn": 1, zh: 1}, rtl: {ar: 1, fa: 1, he: 1, ku: 1, ug: 1}, load: function (b, c, a) {
            ...
            this[b] ? a(b, this[b]) : CKEDITOR.scriptLoader.load(CKEDITOR.getUrl("lang/" + b + ".js"), function () {
                this[b] && (this[b].dir = this.rtl[b] ? "rtl" : "ltr");
                a(b, this[b])
            }, this)
        }, detect: function (b, c) {
            ...
            var e = {}, h = function (a) {
                b.call(this, a, function (a) {
                    ...
                    for (j in a) {
                        ...
                        if (!c[j]) {
                            if (q&&q.icons)for (var l = q.icons.split(","), g = l.length; g--;)CKEDITOR.skin.addIcon(l[g], q.path + "icons/" + (CKEDITOR.env.hidpi && q.hidpi ? "hidpi/" : "") + l[g] + ".png");
                            c[j] = 1
                        }
                        if (r) {
                            r.split && (r = r.split(","));
    ...
    (function () {
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {addCommand: function (a, b) {
			...
			var _this = this;
            _this.focusEnd && window.setTimeout(function(){//初始化
				if(window.getSelection){//W3C
					var range = _this.window.$.document.createRange();//Create a range (a range is a like the selection but invisible)
					range.selectNodeContents(_this.document.$.body);//Select the entire contents of the element with the range
					range.collapse(false);//collapse the range to the end point. false means collapse to end rather than the start
					var selection = _this.window.$.getSelection();//get the selection object (allows you to change selection)
					selection.removeAllRanges();//remove any selections already made
					selection.addRange(range);	
				}else{
					var range = document.selection.createRange();
					range.moveToElementText(_this.document.$.body);
					range.collapse(false);
					range.select();
				}
                _this.focusEnd = false;
			},10);
        }, checkDirty: function () {
    ...
    (function () {
        function k(a) {
            var d = this.editor, b = a.document;
            if(!b) return;
            var c = b.body;
