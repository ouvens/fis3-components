/*! TenVideoPlayer_V2 - v2.0.0 - 2015-08-27 16:21:59
 * Copyright (c) 2015
...
function(a) { !
    ...
    tvp.lastModify = "2015-08-27 16:21:59", tvp.ts = tvp.lastModify.replace(/\D/g, ""), tvp.ver = "$V2.0Build5316$", tvp.name = "\u817e\u8baf\u89c6\u9891\u7edf\u4e00\u64ad\u653e\u5668", "undefined" == typeof window.DEBUG && (window.DEBUG = 1), window.FILEPATH = "//imgcache.qq.com/tencentvideo_v1/tvp/js/", top != window) try {
    ...
    function(a) {
        function b(b) {
            ...
            window.ActiveXObject) {
                var s = 6; (window.XMLHttpRequest || b.indexOf("MSIE 7.0") > -1) && (s = 7),
                (window.XDomainRequest || b.indexOf("Trident/4.0") > -1) && (s = 8),
                b.indexOf("Trident/5.0") > -1 && (s = 9),
                b.indexOf("Trident/6.0") > -1 && (s = 10),
                a.browser.ie = !0,
                a.browser.version = s
            } else b.indexOf("Trident/7.0") > -1 && (a.browser.ie = !0, a.browser.version = 11);
            r && (this.os.android = !0, this.os.version = r[2]),
            ...
            q && (this.browser.AndriodBrowser = !0),
            i && (this.browser.M1 = !0),
    ...
    tvp.common = {
        ...
        isMac: function() {
            var a = /MacIntel/gi.test(navigator.platform.toLowerCase());
            return a
        },
        ...
        getSKey: function(a) {
            ...
            c = tvp.$.cookie.get("lskey"),
            d = "";
            return "undefined" == typeof isLeak && ("undefined" != typeof a ? isLeak = a: isLeak = !1),
            d = isLeak ? "" != b && "" != c ? [b, c].join(";") : b || c: b
        },
        getToken: function(a) {
        ...
        get_request_url: function(a) {
            var b = {
                ...
                zb: ["http://info.zb.qq.com", "https://sec.video.qq.com/p/info.zb/"],
        ...
        get_chid: function() {
            var a;
            return /(.*\.)3g\.qq\.com$/i.test(document.location.hostname) ? a = 13 : "v.qq.com" === document.location.hostname ? a = 0 : 1 === tvp.app.pageType ? a = 3 : 2 === tvp.app.pageType && (a = 10),
            a
        },
        ...
        is_mqq_buluo: function() {
            return 2 !== tvp.app.pageType || "xiaoqu.qq.com" !== window.location.hostname && "buluo.qq.com" !== window.location.hostname ? !1 : !0
        }
    },
        ...
        return "film.qq.com" == document.location.host && (i = !0),
        {
            getOcx: function(b) {
                ...
                if (tvp.$.browser.ie) try {
                    ...
                    i && !h && (h = !0) && (g.src = "http://btrace.qq.com/collect?sIp=&iQQ=" + tvp.common.getUin() + "&sBiz=IE&sOp=" + encodeURIComponent(navigator.userAgent) + "&iSta=0&iTy=2432&iFlow=&sUrl=" + encodeURIComponent(location.toString()) + "&sRef=" + encodeURIComponent(document.referrer) + "&sMsg=" + encodeURIComponent(j.message) + "&sStep=" + encodeURIComponent(e) + "&_=" + Math.random())
            ...
            getFlash: function() {
                ...
                if (tvp.$.browser.ie) try {
                    ...
                    i && !h && (h = !0) && (g.src = "http://btrace.qq.com/collect?sIp=&iQQ=" + tvp.common.getUin() + "&sBiz=IE&sOp=" + encodeURIComponent(navigator.userAgent) + "&iSta=1&iTy=2432&iFlow=&sUrl=" + encodeURIComponent(location.toString()) + "&sRef=" + encodeURIComponent(document.referrer) + "&sMsg=" + encodeURIComponent(l.message) + "&sStep=" + encodeURIComponent(a) + "&_=" + Math.random())
    ...
    function(a, b) {
        ...
        a.app = {
            ...
            buildResult: function(c, d, e) {
                ...
                j = this;
                return h && !d.openUrl && (1 == g && (i += "&callback=weixin%3A%2F%2F&sender=%e5%be%ae%e4%bf%a1"), 2 == g && (i += "&callback=mqqapi%3A%2F%2F&sender=%E6%89%8B%E6%9C%BAQQ"), 3 == g && (i += "&callback=mqqbrowser%3A%2F%2F&sender=QQ%E6%B5%8F%E8%A7%88%E5%99%A8")),
                f = 1 == c ? i: b.os.iphone && d.pay && d.cid ? a.app.getPayUrl(d.cid) : j.getDownloadUrl(d.downloadUrl, d.appName),
                {
                    hasApp: c,
                    pageType: g,
                    os: h,
    ...
    tvp.defaultConfig = {
        ...
        html5Preload: "null",
        html5VodUIFeature: ["controlbar", "tips", "title", "meta", "playpause", "progress", "timepanel", "fullscreen", "overlay", "bigben", "posterlayer", "shadow", "promotion", "loadingAd", "adonend", "bullet"],
        html5LiveUIFeature: ["controlbar", "tips", "playpause", "fullscreen", "overlay", "posterlayer", "shadow", "bullet"],
    ...
    tvp.bossReport = {
        rcmdTextReport: function(a, b, c, d) {
            ...
            var k = new Image,
            l = "http://btrace.qq.com/kvcollect?BossId=2745&Pwd=0&_dc=" + Math.random();
            l += "&" + tvp.$.param(e),
            k.src = l
        },
        window_error: function(a) {
            var b = {};
            if (b.filename = a.filename, b.lineno = a.lineno, b.colno = a.colno, b.msg = a.message, b.ua = navigator.userAgent, b.url = top.location.href, b.url = b.url ? b.url: window.location.href, b.filename) {
                var c = new Image,
                d = "http://btrace.qq.com/kvcollect?BossId=2869&Pwd=637403767&_dc=" + Math.random();
                d += "&" + tvp.$.param(b),
                c.src = d
            }
        },
        play_report: function(a) {
            if (a && !tvp.$.isEmptyObject(a)) {
                var b = "http://btrace.qq.com/kvcollect?BossId=2865&Pwd=1698957057&_dc=" + Math.random();
                b += "&" + a.join("&"),
                tvp.report(b)
            }
        },
        user_action_report: function(a) {
            ...
            c = new Image,
            d = "http://btrace.qq.com/kvcollect?BossId=2797&Pwd=219856622&_dc=" + Math.random();
            d += "&" + tvp.$.param(b),
            c.src = d
        },
        apprecommend_report: function(a) {
            ...
            g = new Image,
            h = "http://btrace.qq.com/kvcollect?BossId=2745&Pwd=0&_dc=" + Math.random();
            h += "&" + tvp.$.param(f),
            g.src = h
        },
        report_bullet_switch: function(a) {
            ...
            if (a.platform = b.os.android ? 1 : b.os.iphone ? 2 : b.os.ipad ? 3 : 4, a.url = window.location.href, "undefined" !== b.type(a.user_action)) {
                var c = "http://btrace.qq.com/kvcollect?BossId=3084&Pwd=1539562724&_dc=" + Math.random();
                c += "&" + b.param(a),
                tvp.report(c)
            }
        },
        h5_live_quality: function(a) {
            ...
            c = "http://btrace.qq.com/kvcollect?BossId=3101&Pwd=1037836152&_dc=" + Math.random();
            c += "&" + tvp.$.param(b),
            tvp.report(c)
        }
    },
    function() {
        "v.qq.com" == window.location.hostname && (window.addEventListener ? window.addEventListener("error", tvp.bossReport.window_error) : window.attachEvent("onerror", tvp.bossReport.window_error))
    } (),
    tvp.retCode = {
        snid: 0,
        TYPE: {
    ...
    e.$xx = function(a, b, c, d) {
        var f = "" + Math.floor((new Date).valueOf() / 1e3),
        d = ("" + d).charAt(0),
        g = "",
        h = "",
        i = {
    ...
    function(a, b) {
        ...
        {
            reg: function() {
                return 3 === a.app.pageType && window === top ? !0 : !1
            },
            request: function(c) {
                var d, e, f = this,
                g = function() {
                    ...
                    e.timestamp = parseInt( + new Date / 1e3),
                ...
                d || e ? g() : a.app.loadMqqAPI().done(function() {
                    d || e ? g() : c.reject()
                }).fail(function() {
                    c.reject()
                })
        ...
        {
            reg: function() {
                var a = navigator.userAgent.toLowerCase().indexOf("qqnews") > -1,
                b = navigator.userAgent.toLowerCase().indexOf("qnreading") > -1;
                return a || b ? !0 : !1
            },
            request: function(a) {
                var c = this,
                d = c.cfg.vid,
                e = "undefined" != typeof c.cfg.svr_time ? c.cfg.svr_time + "": parseInt( + new Date / 1e3) + "",
                f = "TVP_KUAIBAO_CB_" + e.substr( - 4, 4);
                window[f] = function(b) {
                    var d;
                    try {
                ...
                var g = function() {
                    ...
                    b = "jsbridge://get_with_json_data?json=" + encodeURIComponent(JSON.stringify(a)) + "&_t=" + e,
                    c = new Image;
                    c.src = b
                },
                h = function() {
                    ...
                    "function" == typeof window.getBrowserSignature ? a() : document.addEventListener("TencentNewsJSInjectionComplete",
                    function() {
                        a()
                    })
                };
        ...
        },
        {
            reg: function() {
                ...
                b = a.indexOf("liebao") > -1,
                c = a.indexOf("com.douban") > -1;
                return c || b ? !0 : !1
            },
            request: function(a) {
                var b, c = this,
    ...
    function(a, b) {
        function c() {
            var a = "view.inews.qq.com" === j.host;
            return b.os.iphone || b.os.ipod ? a ? "v3110": "v3010": b.os.ipad ? a ? "v4110": "v4010": b.os.android ? b.os.tablet ? "v6010": a ? "v5110": "v5010": b.browser.IEMobile ? "v7010": "v1010"
        }
        function d(a, b) {
            for (var c = 0,
        ...
        function g(a) {
            ...
            k && "string" == typeof a.path && (a.path = a.path.replace(/\/\/(.+?)(\/|#|$|\?)/,
            function() {
                return arguments.length > 1 ? arguments[0].replace(arguments[1], k) : arguments[0]
            })),
        ...
        function i(d) {
            ...
            if ("object" == typeof e && "function" == typeof e.$xx && "string" == typeof d) {
                f = b.getUrlParam("platform", d),
                g = b.getUrlParam("vids", d),
                h = c(),
                d.indexOf("mvgetinfo?") > -1 && (b.os.iphone ? h = "V3013": b.os.ipad ? h = "V4013": b.os.android && (h = "V5013"));
                try {
                    k = e.$xx(f, g, h, j)
                } catch(l) {
                    "function" == typeof a.reportErr && l && l.message && a.reportErr(l.message)
                }
                k && (i = i + "&_qv_rmt=" + k.u1, i = i + "&_qv_rmt2=" + k.u2, b.getUrlParam("sdtfrom", d) || (i = i + "&sdtfrom=" + h), d = d + ( - 1 == d.indexOf("?") ? "?": "&") + i, b.cookie.set("qv_als", k.c))
            }
            return d
        }
        var j = {
        ...
        j.retryCgi = function() {
            return b.browser.WeChat || b.browser.MQQClient ? {
                getinfo: j.cgi.getinfo.replace(/(\/\/)(.+?)(\/|$)/, "$1bkh5vv.video.qq.com$3"),
                getkey: j.cgi.getkey.replace(/(\/\/)(.+?)(\/|$)/, "$1bkh5vv.video.qq.com$3")
            }: {
                getinfo: j.cgi.getinfo.replace(/(\/\/)(.+?)(\/|$)/, "$1bkh5vv.video.qq.com$3"),
                getkey: j.cgi.getkey.replace(/(\/\/)(.+?)(\/|$)/, "$1bkh5vv.video.qq.com$3")
            }
        ...
        a.h5Helper = {
            ...
            loadVideoUrlByVid_base: function(e, f) {
                ...
                o = 0,
                p = b.Deferred();
                b.extend(b.extend(m, j), e);
                var q, r = new a.RetCode(100126),
                s = !1,
                t = j.cgi.getinfo,
                u = b.now(),
                v = 0,
                ...
                e.retryDefer && b.isFunction(e.retryDefer.reject) && (s = !0, p = e.retryDefer, t = j.retryCgi.getinfo, y = j.retryCgi.getkey),
                e.loadingAdCgi && (t = e.loadingAdCgi, e.noAuth = !0),
                e.defer && (p = e.defer),
                x = h({
                    itype: 1,
                    val2: s ? 1 : 0,
                ...
                var z = function(d) {
                    return v = b.now() - u,
                    d && d.s ? "o" != d.s ? (o = d.em || 50, l = d.exem) : d.vl && d.vl.vi && b.isArray(d.vl.vi) && 0 != d.vl.cnt ? k = d.vl.vi[0] : o = 68 : o = 50,
                    0 != o || 5 == k.fst && b.isPlainObject(k.ul) && b.isArray(k.ul.ui) && 0 != k.ul.ui.length ? 0 == o && 2 != k.st && (8 != k.st ? o = 62 : (o = 83, l = k.ch)) : o = 62,
                    e.yyactid && 83 === o && (l = -3),
                    a.common.is_mqq_buluo() && (l = 0),
                    0 != o ? (x({
                        val: o,
                        speed: v
                    }), r.reportErr(o), void p.reject(o, l)) : (r.reportSuc(), x({
                        val: 0,
                        speed: v
                    }), e.loadingAdCgi ? void p.resolve(k.ul.ui[0].url, {
                        vl: d.vl,
                        fl: d.fl,
                        sfl: d.sfl,
                        exem: d.exem,
                ...
                A = function(f) {
                    ...
                    b.ajax({
                        ...
                        s ? p.reject(500, 2) : (e.retryDefer = p, a.h5Helper.loadVideoUrlByVid(e))
                    })
                },
                B = function() {
                    w = t + b.param(q),
                    f && "object" === b.type(f) && (w += "&" + b.param(f)),
                    w = i(w),
                    b.ajax({
                        url: w,
                        dataType: "jsonp"
                    }).done(function(b) {
                        return ! e.noAuth && b && 0 != b.em && "o" != b.s ? 85 === b.em && -3 === b.type && 1 === e.cgi_auth_index ? (e.cgi_auth_index += 1, e.defer = p, e.needTime = !0, e.svr_time = b.curTime, void a.h5Helper.loadVideoUrlByVid(e)) : (e.noAuth = !0, e.defer = p, void a.h5Helper.loadVideoUrlByVid(e)) : void z(b)
                    }).fail(function() {
                        r.reportErr(),
                        x({
                            val: 500,
                        ...
                        s ? p.reject(500, 1) : (e.noAuth = !0, e.retryDefer = p, a.h5Helper.loadVideoUrlByVid(e))
                    })
                };
                return e.cgi_auth_index || (e.cgi_auth_index = 1),
                a.auth(m, j).done(function(a) {
                    a = a || {},
                    "undefined" !== b.type(a.cgi) && a.cgi && (t = a.cgi),
                    "undefined" !== b.type(a.cgi2) && a.cgi2 && (y = a.cgi2),
                    a.param && b.extend(q, a.param),
                    B()
                }).fail(function() {
                    b.extend(q, {
                        vids: m.vid,
            ...
            loadSRT: function(a) {
                var c = {},
                d = b.Deferred();
                return b.extend(b.extend(c, j), a),
                b.ajax({
            ...
            setSpecialVideoFileDomain: function(a) {
                "string" == typeof a && /^(\S+[\.])?qq\.com/.test(location.host) && (k = a)
            }
        }
    } (tvp, tvp.$),
    function(a, b) {
        a.BasePlayer = function() {
            ...
            this.instance = null,
            this.dataset = {},
            this.eventList = ["inited", "play", "playing", "ended", "allended", "pause", "resume", "timeupdate", "getnext", "error", "stop", "fullscreen", "change", "write", "flashpopup", "getnextenable", "msg", "h5loadingadstart", "h5loadingadend"],
            this.config = {},
    ...
    var f = f || {
        ver: "$Rev: 90013 $",
        curSSO: "",
        lastmodify: "$Date: 2015-08-27 16:28:49 +0800 (鍥�, 2015-08-27) $"
    };
    f.log = tvp.log,
    f.debug = function(a) {
        var b = "";
    ...
    function(a, b) {
        a.livehub = {
            ...
            FlashChecker: function(c) {
                ...
                this.send = function() {
                    if (e(1), a.common.isUseHtml5()) return e(2),
    ...
    function(a, b) {
        ...
        function e(c, d) {
            ...
            var g = b.Deferred();
            a[e] = g;
            var h = "//imgcache.qq.com/tencentvideo_v1/tvp/js/",
            i = c.toLowerCase();
            "OcxPlayer" == c && "undefined" != typeof f && "undefined" != typeof f.DEFINE && (i = "ocxplayerlite");
            var j = h + "module/" + i + ".js?max_age=86400&v=" + a.ts;
            if ("function" == typeof a[c]) g.resolve();
                ...
                function() {
                    var e = b.now() - l;
                    if ("function" != typeof a[c]) throw k.reportErr(11),
                    d(2, 11, e),
                    new Error(errMsg[1]);
                    d(2, 0, e),
                    k.reportSuc(),
        ...
        i = function(c, d) {
            ...
            function h() {
                ...
                g = /ipad|ipod|iphone|playstation/gi.test(b);
                return a.common.isEnforceMP4() ? void(t = "MP4Link") : e || g || a.$.os.android ? void(a.common.isSupportMP4() || a.common.isInUseH5() ? m() : t = "MP4Link") : (isNaN(d) || 10 > d) && f && a.common.isSupportMP4() ? void m() : void(t = "FlashPlayer")
            }
            function j(c) {
                if (c.getChannelId()) {
            ...
            i.checkLivePlayer = j,
            b.when(c.type == a.PLAYER_DEFINE.VOD ? f() : j(c.video)).then(function() {
                var f = "",
                g = function(b, d, e) {
                    a.report({
                        cmd: 3531,
                        ...
                        function(a, d) {
                            if (d && a in f.config.pluginUrl) {
                                ...
                                if (!c(a, g)) {
                                    ...
                                    b.isString(h) && "" != b.trim(h) && b.getScript(h,
                                    function() {
                                        c(a, g)
                                    })
                                }
    ...
    function(a) {
        tvp.modeHide = function(b, c) {
            ...
            function g() {
                i && (document.webkitIsFullScreen || i.webkitDisplayingFullscreen || k || n.isFakeFullscreen() || (i.pause(), l.hide()))
            }
            function h() {
    ...
    "function" == typeof define && define("tvp_bugfix", [],
    function() {
        return tvp
    }),
    a.tvp = tvp,
...
/*  |xGv00|6183792dcd321788bbb5db87cd1fb5c4 */
